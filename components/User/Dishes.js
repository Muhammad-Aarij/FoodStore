...
import { Alert, StyleSheet, Text, TouchableOpacity, TextInput, View, FlatList, Image, Pressable, SafeAreaView, ActivityIndicator, Touchable, ScrollView } from 'react-native';
...
export default function Dishes({ navigation, route }) {
    ...
    const orders = [
        ...
        { name: 'Butter Chicken', price: 250, source: './SouthAsian/Naan', category: 'South Asian' },
    ...
    const handleQuantityChange = (text) => {
        // Validate input and set quantity state
        if (/^[1-9]$/.test(text)) {
            setQuantity(text);
        }
    };
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            ...
                            <View>
                                ...
                                <View style={{ flexDirection: "row" }}>
                                    <Text style={styles.txtt}>Quantity</Text>
                                    <TextInput
                                        style={styles.input}
                                ...
                                <Pressable style={{  backgroundColor: 'rgba(247, 97, 6, 0.7)', borderRadius: 50, justifyContent: "center", paddingBottom: 6, width: 130, marginLeft: "6%" ,marginTop: 6}}>
                                    <Text style={{ alignSelf: "center", color: "white", fontSize: 20, fontFamily: 'cursive', fontWeight: "bold", }}>Add to Cart</Text>
                                </Pressable>
